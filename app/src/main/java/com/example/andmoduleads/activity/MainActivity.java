...
import com.ads.control.ads.bannerAds.NoDoorBannerAdView;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NoDoorAd.getInstance().setCountClickToShowAds(3);
         ...
         */
        itgNativeAdView.loadNativeAd(this, idNative, new NoDoorAdCallback() {
            @Override
        ...
        NoDoorBannerAdView bannerAdView = findViewById(R.id.bannerView);
        bannerAdView.loadBanner(this, idBanner, new NoDoorAdCallback() {
            @Override
            public void onAdImpression() {
                super.onAdImpression();
            }
        ...
        findViewById(R.id.btShowAds).setOnClickListener(v -> {
            if (mInterstitialAd.isReady()) {
                ...
                ApInterstitialAd inter = NoDoorAd.getInstance().getInterstitialAds(this, idInter);

                NoDoorAd.getInstance().showInterstitialAdByTimes(this, mInterstitialAd, new NoDoorAdCallback() {
                    @Override
        ...
        findViewById(R.id.btnShowReward).setOnClickListener(v -> {
            ...
            rewardAd = NoDoorAd.getInstance().getRewardAd(this,  BuildConfig.ad_reward);
        });
    ...
    private void configMediationProvider() {
        if (NoDoorAd.getInstance().getMediationProvider() == ITGAdConfig.PROVIDER_ADMOB) {
    ...
    private void loadAdInterstitial() {
        ...
        mInterstitialAd = NoDoorAd.getInstance().getInterstitialAds(this, idInter);
    }


    public void onTrackSimpleEventClick(View v) {
        NoDoorAdjust.onTrackEvent(EVENT_TOKEN_SIMPLE);
    }

    public void onTrackRevenueEventClick(View v) {
        NoDoorAdjust.onTrackRevenue(EVENT_TOKEN_REVENUE, 1f, "EUR");
    }
