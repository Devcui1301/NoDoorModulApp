...
public class ITGNativeAdView extends RelativeLayout {
    ...
    public void populateNativeAdView(Activity activity, ApNativeAd nativeAd){
        ...
        NoDoorAd.getInstance().populateNativeAdView(activity, nativeAd, layoutPlaceHolder, layoutLoading);
    }

    public void loadNativeAd(Activity activity, String idAd ) {
        loadNativeAd(activity, idAd, new NoDoorAdCallback(){});
    }
    public void loadNativeAd(Activity activity, String idAd, NoDoorAdCallback ITGAdCallback) {
        if(layoutLoading == null){
        ...
        NoDoorAd.getInstance().loadNativeAd(activity, idAd, layoutCustomNativeAd, layoutPlaceHolder, layoutLoading,ITGAdCallback);
    }
    ...
    public void loadNativeAd(Activity activity, String idAd, int layoutCustomNativeAd, int idLayoutLoading, NoDoorAdCallback ITGAdCallback) {
        setLayoutLoading(idLayoutLoading);
        setLayoutCustomNativeAd(layoutCustomNativeAd);
