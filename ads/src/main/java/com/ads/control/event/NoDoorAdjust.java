...
public class NoDoorAdjust {
    ...
    public static void setEventNamePurchase(String eventNamePurchase) {
        NoDoorAdjust.eventNamePurchase = eventNamePurchase;
    }
    ...
    static void logPaidAdImpressionValue(double revenue, String currency) {
        if (NoDoorAd.getInstance().getAdConfig().getAdjustConfig() != null && NoDoorAd.getInstance().getAdConfig().getAdjustConfig().isEnableAdjust()) {
            AdjustEvent event = new AdjustEvent(NoDoorAd.getInstance().getAdConfig().getAdjustConfig().getEventAdImpression());
