 ...
 */
public class NoDoorAppsflyer {
    private static final String TAG = "AperoAppsflyer";
    private Context context;
    private static NoDoorAppsflyer ITGAppsflyer;
    public static boolean enableAppsflyer = false;

    public NoDoorAppsflyer() {
    }

    public static NoDoorAppsflyer getInstance(){
        if (ITGAppsflyer ==null)
            ITGAppsflyer = new NoDoorAppsflyer();
        return ITGAppsflyer;
    }
